            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <div className="flex gap-8">
                <div className="text-center">
                  <h4 className="text-lg font-semibold text-gray-400">Employees</h4>
                  <p className="text-2xl text-blue-400">{company.stats.employees}</p>
                </div>
                <div className="text-center">
                  <h4 className="text-lg font-semibold text-gray-400">Projects</h4>
                  <p className="text-2xl text-blue-400">{company.stats.projects}</p>
                </div>
                <div className="text-center">
                  <h4 className="text-lg font-semibold text-gray-400">Rating</h4>
                  <p className="text-2xl text-yellow-400">{company.stats.rating} / 5</p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 text-sm">
                <a href={`mailto:${company.email}`} className="flex items-center text-gray-400 hover:text-blue-400">
                  <Mail className="h-4 w-4 mr-1" />
                  {company.email}
                </a>
                <a href={`tel:${company.phone}`} className="flex items-center text-gray-400 hover:text-blue-400">
                  <Phone className="h-4 w-4 mr-1" />
                  {company.phone}
                </a>
                <a href={`https://${company.website}`} className="flex items-center text-gray-400 hover:text-blue-400">
